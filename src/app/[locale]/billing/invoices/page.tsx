    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <Link href={`/${locale}/billing`} className="text-[color:var(--be-blue)] hover:text-[color:var(--be-blue-hover)]">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm space-x-2">
                        {invoice.pdf_url && (
                          <a
                            ...
                            className="text-[color:var(--be-blue)] hover:text-[color:var(--be-blue-hover)] font-medium"
                          >
                            PDF
                          </a>
                        )}
