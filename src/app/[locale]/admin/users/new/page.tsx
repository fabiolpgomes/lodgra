              ...
              <div>
                ...
                <div className="mt-1 flex gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-[color:var(--be-blue-pale)] text-blue-600 hover:bg-[color:var(--be-blue-pale)] border border-[color:var(--be-blue-light)] rounded transition-colors"
                  >
                    {copied ? (
