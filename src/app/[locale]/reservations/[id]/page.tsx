  ...
  return (
    <AuthLayout profile={access.profile}>
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="bg-[#F7F5EF] rounded-xl p-8">
          {/* Header */}
          <div className="mb-8">
            <Link href={`/${locale}/reservations`}>
              <Button variant="ghost" size="sm" className="mb-4 text-[#10203E] hover:bg-[#FBFAF6]">
            ...
            <div className="flex items-start justify-between">
              <div>
                <h1 className="text-3xl font-bold text-[#1B2430]">Detalhes da Reserva</h1>
                <p className="text-sm text-[#4D5566] mt-1">ID: {reservation.id}</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <div className="bg-[#FBFAF6] rounded-[14px] border border-[#E5DFD2] p-6">
                <h2 className="text-base font-semibold text-[#1B2430] mb-4 flex items-center gap-2">
                  <MapPin className="h-5 w-5 text-[#4D5566]" />
                  Propriedade
                </h2>
                <div className="space-y-3">
                  <div>
                    <p className="text-sm text-[#4D5566] font-medium">Nome</p>
                    <p className="text-base text-[#1B2430]">{property?.name || '-'}</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm text-[#4D5566] font-medium">Cidade</p>
                      <p className="text-base text-[#1B2430]">{property?.city || '-'}</p>
                    </div>
                    <div>
                      <p className="text-sm text-[#4D5566] font-medium">País</p>
                      <p className="text-base text-[#1B2430]">{property?.country || '-'}</p>
                    </div>
                  </div>
                  {platformName && (
                    <div className="pt-2 border-t border-[#E5DFD2]">
                      <p className="text-sm text-[#4D5566] font-medium">Plataforma</p>
                      <p className="inline-block px-3 py-1 text-sm font-medium bg-[#10203E]/10 text-[#10203E] rounded-full mt-1">
                        {platformName}
                      </p>
                    </div>
                  )}
              ...
              <div className="bg-[#FBFAF6] rounded-[14px] border border-[#E5DFD2] p-6">
                <h2 className="text-base font-semibold text-[#1B2430] mb-4 flex items-center gap-2">
                  <User className="h-5 w-5 text-[#4D5566]" />
                  Hóspede
                </h2>
                <div className="space-y-3">
                  <div>
                    <p className="text-sm text-[#4D5566] font-medium">Nome</p>
                    <p className="text-base text-[#1B2430]">
                      {reservation.guest_name || `${reservation.first_name || ''} ${reservation.last_name || ''}`.trim() || '-'}
                    </p>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm text-[#4D5566] font-medium">Email</p>
                      <p className="text-sm text-[#1B2430] break-all">{reservation.guest_email || '-'}</p>
                    </div>
                    <div>
                      <p className="text-sm text-[#4D5566] font-medium">Telefone</p>
                      <p className="text-sm text-[#1B2430]">{reservation.guest_phone || '-'}</p>
                    </div>
                  </div>
                  <div className="pt-2 border-t border-[#E5DFD2]">
                    <p className="text-sm text-[#4D5566] font-medium">Número de Hóspedes</p>
                    <p className="text-base text-[#1B2430] mt-1">{reservation.number_of_guests || '-'}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#FBFAF6] rounded-[14px] border border-[#E5DFD2] p-6">
                <h2 className="text-base font-semibold text-[#1B2430] mb-4 flex items-center gap-2">
                  <Calendar className="h-5 w-5 text-[#4D5566]" />
                  Período da Reserva
                </h2>
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm text-[#4D5566] font-medium">Check-in</p>
                      <p className="text-base text-[#1B2430]">{checkInFormatted}</p>
                    </div>
                    <div>
                      <p className="text-sm text-[#4D5566] font-medium">Check-out</p>
                      <p className="text-base text-[#1B2430]">{checkOutFormatted}</p>
                    </div>
                  </div>
                  <div className="pt-2 border-t border-[#E5DFD2]">
                    <p className="text-sm text-[#4D5566] font-medium">Número de Noites</p>
                    <p className="text-base text-[#1B2430] mt-1">{reservation.number_of_nights || '-'}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#FBFAF6] rounded-[14px] border border-[#E5DFD2] p-6">
                <h2 className="text-base font-semibold text-[#1B2430] mb-4">Informações da Reserva</h2>
                <div className="space-y-4">
                  <div>
                    <p className="text-sm text-[#4D5566] font-medium">Número da Reserva</p>
                    <p className="text-base font-mono text-[#1B2430] bg-[#F7F5EF] p-3 rounded-lg border border-[#E5DFD2] mt-1">{reservation.external_reservation_id || '-'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-[#4D5566] font-medium">Plataforma</p>
            ...
            <div className="md:col-span-1 space-y-6">
              {/* Price Card */}
              <div className="bg-[#FBFAF6] rounded-[14px] border border-[#E5DFD2] p-6 sticky top-6">
                <h2 className="text-base font-semibold text-[#1B2430] mb-2 flex items-center gap-2">
              ...
              {/* Status Card */}
              <div className="bg-[#FBFAF6] rounded-[14px] border border-[#E5DFD2] p-6">
                <h2 className="text-base font-semibold text-[#1B2430] mb-4">Status</h2>
                <div className="mb-4">
                ...
                <div className="text-sm text-[#4D5566]">
                  <p className="font-medium text-[#1B2430]">Criada em:</p>
