              ...
              <div className="p-4">
                ...
                <div className="flex flex-col gap-3 mt-6 pt-4 border-t border-gray-200 sm:flex-row">
                  ...
                  <button
                    ...
                    disabled={saving}
                    className="flex w-full items-center justify-center gap-2 rounded-lg bg-gray-900 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-gray-700 disabled:opacity-60 sm:flex-1"
                  >
