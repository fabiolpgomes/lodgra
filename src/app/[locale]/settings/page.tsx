                    ...
                    {bookingUrl && (
                      <>
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="mt-1 inline-flex max-w-full items-center gap-1 truncate text-sm font-medium text-brand-700 hover:text-brand-800"
                        >
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">
                  Gerencie templates de checklists para tarefas de limpeza e configure assignments para cleaners.
                </p>
              </div>
              <Link
