...
import { PropertyAnalysis } from '@/components/reports/PropertyAnalysis'
import { MonthlyComparison } from '@/components/reports/MonthlyComparison'
import { PLStatement } from '@/components/reports/PLStatement'
import { ChannelAnalysis } from '@/components/reports/ChannelAnalysis'
import { CashFlowForecast } from '@/components/reports/CashFlowForecast'
import { FinancialPdfDownloadButton } from '@/components/reports/FinancialPdfDownloadButton'
import { formatMultiCurrencyTotals, formatCurrency, groupByCurrency, CurrencyCode } from '@/lib/utils/currency'
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-1">
              {Object.entries(revenueByCurrency).length > 0 ? (
                Object.entries(revenueByCurrency).slice(0, 2).map(([currency, amount]) => (
                  <h3 key={currency} className="text-2xl font-bold text-green-600">
                    {formatMultiCurrencyTotals({ [currency]: amount })}
                  </h3>
                ))
              ) : (
