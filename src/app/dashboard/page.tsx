...
/**
 * /dashboard — Redirects to locale-specific dashboard or calendar based on role, preserving search params
 */
export default async function DashboardRedirect({
  ...
  // Default to dashboard for admin/gestor; if profile is null fall back to dashboard too
