/**
 * POST /api/cleaning/templates/seed-execute
 * Execute template seeding immediately
 * Creates 3 standard cleaning templates in the database
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('POST /api/cleaning/templates/seed-execute error:', error);
    return NextResponse.json(
