...
export function TopBar() {
  ...
  return (
    <>
      <header className="hidden md:flex items-center justify-between h-[64px] px-8 bg-white border-b border-lodgra-blue/10 sticky top-0 z-30">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={handleOpen}
            className="flex items-center gap-1 px-3 py-1.5 bg-[#f8f8f8] border border-lodgra-blue/5 rounded hover:bg-[#f0f0f0] transition-colors"
          >
