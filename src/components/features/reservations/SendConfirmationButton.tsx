  ...
  return (
    <div className="space-y-2">
      <button
        ...
        className="w-full flex items-center justify-between gap-2 px-3 py-2 text-brand-700 hover:bg-brand-100 rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
