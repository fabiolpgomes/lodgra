...
export function ForecastCard({ forecast, period, onClick }: ForecastCardProps) {
  ...
  return (
    <button
      ...
      aria-label={`Previsão de ${period} dias: ${formatCurrency(forecast.projectedRevenue)}`}
    >
      {/* Header */}
      ...
      {/* Revenue */}
      <div className="mb-4">
        <p className="text-sm text-slate-600 dark:text-slate-400 mb-1">Receita prevista</p>
