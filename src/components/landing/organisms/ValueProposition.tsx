    ...
    <Container>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="font-inter font-light text-lg md:text-xl text-gray-600 leading-relaxed mb-12">
            {description}
          </p>
          ...
          <ul className="space-y-5">
            {bullets.map((bullet, idx) => (
              <li key={idx} className="flex items-start gap-4">
                ...
                <span className="text-gray-700 text-base font-inter leading-relaxed">{bullet}</span>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className="hidden lg:flex items-center justify-center">
          <div className="w-full aspect-square bg-lodgra-light rounded-2xl flex items-center justify-center">
