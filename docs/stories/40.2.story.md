...
- [ ] POST /api/reservations/[id]/cancel (integrar calculator)
- [ ] POST /api/admin/review/[id]/decision (integrar calculator)
- [ ] E2E tests
...
- [ ] `src/lib/refunds/refund-calculator.ts` (new)
- [ ] `src/__tests__/lib/refund-calculator.test.ts` (new)
