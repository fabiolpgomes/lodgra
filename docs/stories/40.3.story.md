...
- [ ] `src/components/calendar/CancellationCard.tsx` (new)
- [ ] `src/components/modals/CancellationModal.tsx` (new)
- [ ] `src/styles/animations.css` (new)
- [ ] `src/app/property/[id]/calendar/page.tsx` (update)
- [ ] `src/__tests__/components/CancellationModal.test.tsx` (new)
