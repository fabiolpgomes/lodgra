...
**Status:** 5/7 Done (39.1, 39.2, 39.3, 39.4, 39.5). 39.6 e 39.7 aguardando dispatch.
...
| **39.2** | [Badges MoM/YoY + Card ADR/RevPAR + Ajuste Lucro Real](39.2-adr-revpar-badges-lucro-real.md) | A (agente único) | 8 | **Done** (QA PASS) | 39.1 |
