...
REVOKE ALL ON SCHEMA lodgra_private FROM PUBLIC, anon;
GRANT USAGE ON SCHEMA lodgra_private TO authenticated, service_role;
...
CREATE OR REPLACE FUNCTION public.replace_property_payout_rule(
  p_property_id uuid,
  p_expected_current_rule_id uuid,
  p_vigencia_inicio date,
  p_tipo_comissao public.tipo_comissao_repasse,
...
REVOKE ALL ON FUNCTION public.replace_property_payout_rule(
  uuid, uuid, date, public.tipo_comissao_repasse, numeric,
  public.base_comissao_repasse, public.destinatario_taxa_repasse,
  public.destinatario_taxa_repasse, boolean, smallint, text
) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.replace_property_payout_rule(
  uuid, uuid, date, public.tipo_comissao_repasse, numeric,
  public.base_comissao_repasse, public.destinatario_taxa_repasse,
  public.destinatario_taxa_repasse, boolean, smallint, text
) TO authenticated, service_role;

REVOKE INSERT, UPDATE ON TABLE public.regras_repasse FROM authenticated;

COMMENT ON FUNCTION public.replace_property_payout_rule(
  uuid, uuid, date, public.tipo_comissao_repasse, numeric,
  public.base_comissao_repasse, public.destinatario_taxa_repasse,
  public.destinatario_taxa_repasse, boolean, smallint, text
) IS 'Substitui atomicamente a regra aberta de uma propriedade com autorização e concorrência otimista.';
