-- Story 38.1: PostgREST supplies JWT claims as JSON, not individual GUCs.
-- Preserve SECURITY DEFINER, signatures and existing service_role-only grants.
BEGIN;
SELECT pg_advisory_xact_lock(hashtext('lodgra:email-ical-service-role-claims'));
