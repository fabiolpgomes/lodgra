...
DROP FUNCTION IF EXISTS public.guard_ical_reservation_lifecycle();
DROP FUNCTION IF EXISTS public.review_ical_pending_reservation(uuid,uuid,text);
DROP FUNCTION IF EXISTS public.import_ical_pending_reservation(uuid,uuid,text[]);
