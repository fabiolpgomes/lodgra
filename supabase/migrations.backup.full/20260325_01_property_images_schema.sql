...
CREATE TABLE IF NOT EXISTS property_images (
  ...
  CONSTRAINT only_one_primary_per_property UNIQUE NULLS NOT DISTINCT (property_id, is_primary)
...
-- RLS POLICY: INSERT - Only managers and admins can upload images
CREATE POLICY "property_images_insert_manager_or_admin"
  ...
  WITH CHECK (
    ...
    organization_id = get_user_organization_id()
    AND
    -- Must have manager+ role on this property
    EXISTS (
...
-- RLS POLICY: DELETE - Only admins can delete images
