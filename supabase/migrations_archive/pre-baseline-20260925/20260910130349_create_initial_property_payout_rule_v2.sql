...
CREATE OR REPLACE FUNCTION lodgra_private.mutate_property_payout_rule_v2(
  p_property_id uuid,
...
GRANT EXECUTE ON FUNCTION lodgra_private.mutate_property_payout_rule_v2(
  uuid, uuid, boolean, date, public.tipo_comissao_repasse, numeric, numeric,
  text, text, text, boolean, smallint, jsonb, text
...
COMMENT ON FUNCTION lodgra_private.mutate_property_payout_rule_v2(
  uuid, uuid, boolean, date, public.tipo_comissao_repasse, numeric, numeric,
  text, text, text, boolean, smallint, jsonb, text
) IS 'Única mutação atômica de política v2; serializa por propriedade e exige presença ou ausência esperada.';
COMMENT ON FUNCTION public.create_property_payout_rule_v2(
  uuid, date, public.tipo_comissao_repasse, numeric, numeric,
  text, text, text, boolean, smallint, jsonb, text
) IS 'Cria a primeira política financeira v2 somente quando a propriedade ainda não possui regra vigente.';
